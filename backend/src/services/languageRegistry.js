...
Создай короткий Java-код (5-10 строк) с одной реальной ошибкой (логической или синтаксической).
...
Создай короткий Python-код (5-10 строк) с одной реальной ошибкой (логической или синтаксической).
Верни ТОЛЬКО валидный JSON без markdown и комментариев:
...
Создай короткий TypeScript-код (5-10 строк) с одной реальной ошибкой (логической или типизации).
Верни ТОЛЬКО валидный JSON без markdown и комментариев:
