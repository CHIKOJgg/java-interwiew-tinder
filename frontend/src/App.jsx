...
function App() {
  ...
  useEffect(() => {
    ...
    if (window.Telegram?.WebApp) {
      ...
      // Try to authenticate
      const initData = tg.initData || 'user=%7B%22id%22%3A123456789%2C%22first_name%22%3A%22Dev%22%2C%22username%22%3A%22dev_user%22%7D';
      login(initData).catch(console.error);
    } else {
      // Development mode: mock auth
      const mockInitData = 'user=%7B%22id%22%3A123456789%2C%22first_name%22%3A%22Dev%22%2C%22username%22%3A%22dev_user%22%7D';
      login(mockInitData).catch(console.error);
    }
  }, [login]);
